...
let contract;
let contractAddress = "0xdc8F6128c13b5bD909bfa3Df637d9D6b10AB4765"; // beta 4
let provider;
let signer = 0;
let filter;
...
function updateLand(__id){
    ...
    document.getElementById('landLordStat').innerHTML = t_land[__id].lordStat;
...
const joinGame = async() => {
	try {
		...
		notificationSend('About to join game as a member of Tribe ' + _newTribe);
